...
function App() {
    ...
    return (
        <div>
            <div>
                {count?
                    <img style={{zIndex:100,width:toggleDialog?"150px":"100", top:"35%", left:toggleDialog?"30%":"50%", position:"absolute", transform: "translate(-50%,-50%)", transition: "all 0.3s ease-in-out"}} src="/cat_pop1.png" alt="pop cat"/>
                    :
